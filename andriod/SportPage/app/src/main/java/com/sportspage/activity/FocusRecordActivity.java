...
@ContentView(R.layout.activity_focus_record)
public class FocusRecordActivity extends SwipeBackActivity implements
    ...
    private void init() {
        ...
        FocusRecordAdapter adapter = new FocusRecordAdapter(this,mDatas);
    ...
    public void onBGARefreshLayoutBeginRefreshing(BGARefreshLayout refreshLayout) {
        ...
        map.put("size", "10");
        Xutils.getInstance(this).get(API.GET_FOLLOWS, map, new Xutils.XCallBack() {
            @Override
