...
public class AppraiseRecordFragment extends BaseFragment implements
    ...
    public void onBGARefreshLayoutBeginRefreshing(BGARefreshLayout refreshLayout) {
        ...
        map.put("size", "10");
        Xutils.getInstance(mContext,false).get(API.GET_ORDERS_APPRAISE, map, new Xutils.XCallBack() {
            @Override
