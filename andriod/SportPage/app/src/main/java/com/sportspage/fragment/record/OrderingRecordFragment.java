...
public class OrderingRecordFragment extends BaseFragment implements
    ...
    public void onBGARefreshLayoutBeginRefreshing(BGARefreshLayout refreshLayout) {
        ...
        map.put("size", "10");
            Xutils.getInstance(mContext,false).get(API.GET_ORDERS_ING, map, new Xutils.XCallBack() {
            @Override
