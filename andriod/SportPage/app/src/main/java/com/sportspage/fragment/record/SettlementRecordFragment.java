...
public class SettlementRecordFragment extends BaseFragment implements
    ...
    public SettlementRecordFragment(){
    ...
    public void onBGARefreshLayoutBeginRefreshing(BGARefreshLayout refreshLayout) {
        ...
        map.put("size", "10");
        Xutils.getInstance(mContext,false).get(API.GET_ORDERS_SETTLEMENT, map, new Xutils.XCallBack() {
            @Override
