...
@MessageTag(value = "SP:ClubInvite", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class ClubInviteMessage extends MessageContent {
    private String clubId;
    private String imageUrl;
    private String title;
    private String content;

    public ClubInviteMessage(byte[] data) {
        String jsonStr = null;
    ...
    protected ClubInviteMessage(Parcel in) {
    ...
    public static final Creator<ClubInviteMessage> CREATOR = new Creator<ClubInviteMessage>() {
        @Override
        public ClubInviteMessage createFromParcel(Parcel source) {
            return new ClubInviteMessage(source);
        }

        @Override
        public ClubInviteMessage[] newArray(int size) {
            return new ClubInviteMessage[size];
        }
    };
