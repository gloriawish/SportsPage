//
//  SPPersonalSportsPageTableViewCell.m
//  SportsPage
//
...
@interface SPPersonalSportsPageTableViewCell () {
...
@implementation SPPersonalSportsPageTableViewCell
...
- (void)setUp {
    ...
    if (SCREEN_WIDTH == 320) {
        _shadowlayer.frame = CGRectMake(10, 5, 300, 120);
    } else if (SCREEN_WIDTH == 375) {
        _shadowlayer.frame = CGRectMake(10, 5, 355, 120);
    } else {
        _shadowlayer.frame = CGRectMake(10, 5, 394, 120);
    }
